...
Decimals represent parts of a whole using powers of 10 ($0.1, 0.01, 0.001$), while fractions express those same parts as exact ratios of two integers ($\frac{a}{b}$).
...
* *Example ($0.1818...$)*: Repeating block $R = 18$, length $k = 2$.
  $$\text{Fraction} = \frac{18}{10^2 - 1} = \frac{18}{99}$$
  GCF of 18 and 99 is 9 $\implies (18/9) / (99/9) = \mathbf{2 / 11}$.

---

### Common Mistakes to Avoid

1. **Treating Repeating Decimals as Terminating**: Entering $0.333$ as a terminating decimal yields $\frac{333}{1000}$, which does NOT equal $\frac{1}{3}$ ($0.33333...$). Use **Repeating Decimal Mode** for recurring numbers.
2. **Forgetting to Reduce to Lowest Terms**: Leaving $\frac{375}{1000}$ unreduced instead of dividing by GCF $125$ to get $\frac{3}{8}$.
