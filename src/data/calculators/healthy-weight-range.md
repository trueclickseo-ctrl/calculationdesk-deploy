---
title: "Healthy Weight Range Calculator - Height & WHO BMI Bounds"
seoTitle: "Healthy Weight Range Calculator - Calculate Ideal BMI Limits | CalculationDesk"
metaDescription: "Free online Healthy Weight Range Calculator. Estimate your healthy body weight bounds (WHO BMI 18.5 to 24.9) based on height and current body weight."
category: "health"
subcategory: "medical-calculators"
tags: ["healthy weight range calculator", "ideal weight range", "who bmi bounds", "bmi weight bounds calculator", "healthy weight for height"]
priority: "high"
importance: 10
...
titleVariants:
  - "Healthy Weight Range Calculator - Calculate Ideal BMI Limits | CalculationDesk"
aiSummary:
  definition: "The Healthy Weight Range Calculator estimates the upper and lower body weight limits corresponding to a healthy Body Mass Index (BMI 18.5 to 24.9) for your height, based on World Health Organization (WHO) standards."
  quickAnswer: "For an individual standing 180 cm (1.80 m) tall, the healthy weight range is 59.9 kg to 80.7 kg (132.1 lbs to 177.9 lbs)."
  formulaSummary: "Weight Min = 18.5 * H(m)^2 | Weight Max = 24.9 * H(m)^2 | Current BMI = Weight / H(m)^2"
  whenToUse: "Use this tool to find your baseline statistical healthy weight range and assess weight maintenance or fitness goals."
...
peopleAlsoAsk:
  ...
  - "Can a muscular athlete have an 'overweight' BMI while being completely healthy?"
...
# Healthy Weight Range Calculator – Height & WHO BMI Bounds

Understanding your body weight relative to your height provides a useful baseline for long-term wellness. Rather than focusing on a single rigid number on the scale, health organization guidelines recommend a **healthy weight range**.

This calculator uses your height to compute the **World Health Organization (WHO)** adult healthy weight bounds—defined as a **Body Mass Index (BMI) between 18.5 and 24.9**.

If you enter your current weight, it also evaluates your **current BMI**, **weight status classification**, and the exact weight target needed to enter or remain in the healthy range.

---

> [!IMPORTANT]
> **Health Education Disclaimer**: BMI weight ranges are general screening statistics for adult populations. They do not measure body composition, muscle mass, frame size, or metabolic health. Always discuss weight goals with a healthcare professional.
...
### WHO Adult Weight Status Classifications

| BMI Range | World Health Organization Status | Clinical Description |
| :--- | :--- | :--- |
| **Below 18.5** | Underweight | Mass below standard population threshold |
| **18.5 – 24.9** | Normal Weight | Recommended statistical healthy range |
| **25.0 – 29.9** | Overweight | Moderate excess mass relative to height |
| **30.0 or Higher** | Obese | Higher excess mass threshold |
...
### Important Limitations of BMI Ranges
...
Consult a doctor, registered dietitian, or healthcare provider if:
- You are considering major dietary or physical activity changes.
- You have concerns about unexplained weight loss or weight gain.
- You want a comprehensive health assessment that includes blood pressure, lipid panels, and blood glucose testing.
