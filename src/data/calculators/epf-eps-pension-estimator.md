...
faqs:
 ...
 a: "The statutory EPS pension formula is: Monthly Pension =  frac(Pensionable Salary \× Pensionable Service){70}. Pensionable salary is capped at ₹15,000/month."
...
2. **Employer Contribution**: **12%** of basic salary, split into two parts:
 ...
 Employer EPF = (Basic Salary × 0.12) - min(Basic Salary, 15000) × 0.0833
...
Monthly Interest = EPF Balance × frac(Annual Interest Rate){12 × 100}
...
Pensionable Service = min(35, Service Years + (Service Years ge 20 ? 2 : 0))

Pensionable Salary = min(Final Basic Salary, 15000)

Monthly EPS Pension = frac(Pensionable Salary × Pensionable Service){70}
...
1. **EPF Accumulation (33 Years)**:
 - Employee monthly deposit: 50,000 × 12% = ₹6,000/month.
 - Employer EPS deposit: min(50000, 15000) × 8.33% = ₹1,250/month.
 - Employer EPF deposit: ₹6,000 - ₹1,250 = ₹4,750/month.
 - Total monthly EPF deposit: ₹6,000 + ₹4,750 = ₹10,750/month (growing with 5% annual increments and 8.25% monthly compounding interest).
...
2. **EPS Monthly Pension**:
 ...
 - Pensionable Service = min(35, 33 + 2) = 35 years.
 - Pensionable Salary = min(Final Salary, 15000) = ₹15,000.
 - **Monthly EPS Pension**:
...
* **Q1: Why is the maximum monthly EPS pension ₹7,500 in the standard calculator model?**
  * A1: Under standard statutory EPFO rules, pensionable salary is capped at ₹15,000 and maximum pensionable service (including the 2-year bonus) is capped at 35 years. (15,000 × 35 / 70) = ₹7,500.
