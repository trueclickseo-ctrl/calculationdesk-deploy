...
aiSummary:
  definition: "The GPA Calculator computes a credit-weighted Grade Point Average (GPA) for a semester or academic term using course letter grades and credit hour weights."
  quickAnswer: "Taking 4 courses (Math: 4 cr, A; Physics: 3 cr, B+; English: 3 cr, B; total 10 credits) accumulates 34.9 grade points, yielding a weighted semester GPA of 3.490 / 4.3 scale."
  formulaSummary: "GPA = sum(Grade Point_k × Credits_k) / sum(Credits_k) | A+ = 4.3, A = 4.0, A- = 3.7, B+ = 3.3, B = 3.0, B- = 2.7, C+ = 2.3, C = 2.0, C- = 1.7, D = 1.0, F = 0.0"
  whenToUse: "Use this tool to calculate semester GPAs and evaluate how course credit weights impact overall term performance."
...
Computing your **Grade Point Average (GPA)** for a semester requires multiplying the numerical point value of each letter grade by its respective **course credit weight**.

This calculator computes your **weighted semester GPA, total accumulated grade points, and total credit hours**.
...
Suppose you take **3 courses** in a semester with the following records:
1. **Course 1**: 4 Credits, Grade **A** (4.0 points)
2. **Course 2**: 3 Credits, Grade **B+** (3.3 points)
