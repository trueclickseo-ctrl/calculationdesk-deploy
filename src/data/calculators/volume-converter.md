---
title: "Volume Converter - ml, L, Cups, Gallons, fl oz & More"
seoTitle: "Volume Converter - Convert ml, Liters, Cups, Gallons, fl oz | CalculationDesk"
metaDescription: "Free online volume converter. Convert between milliliters, liters, teaspoons, tablespoons, fluid ounces, cups, pints, quarts, gallons, cubic meters, and cubic feet."
category: "conversion"
subcategory: "volume-converters"
tags: ["volume converter", "ml to cups", "liters to gallons", "fluid ounces converter", "cubic feet to liters"]
priority: "high"
importance: 8
...
aiSummary:
  ...
  formulaSummary: "Step 1: Convert input to liters = Input value x liter-factor for that unit | Step 2: Convert liters to target = Total liters / liter-factor for target unit"
  whenToUse: "Use when following recipes in different measurement systems, converting medical liquid volumes, comparing beverage container sizes, or calculating storage and construction volumes."
...
Most of the units in this converter belong to the US customary system, which uses a neat hierarchical structure:
