...
metaDescription: "Free online Post Office Scheme Interest Planner. Calculate returns, maturity values, and periodic interest payouts for POMIS, NSC, KVP, SCSS, and POTD."
category: "financial"
...
aiSummary:
  definition: "The Post Office Scheme Interest Planner estimates maturity amounts, monthly payouts, and quarterly returns across sovereign-backed small savings schemes offered by India Post."
  quickAnswer: "Investing ₹9,00,000 in the Monthly Income Scheme (POMIS) at 7.4% p.a. interest pays ₹5,550 monthly for 5 years (₹3,33,000 total interest), returning the ₹9,00,000 principal at maturity."
  formulaSummary: "POMIS: Monthly = (P × R)/1200 | NSC: A = P × (1 + R/100)^5 | KVP: A = P × 2 | SCSS: Quarterly = (P × R)/400 | POTD: A = P × (1 + R/400)^(4t)"
  whenToUse: "Use this planner to calculate fixed-income payouts and compare sovereign-backed post office savings options."
...
peopleAlsoAsk:
  ...
  - "How many months does Kisan Vikas Patra (KVP) take to double money?"
...
**Post Office Small Savings Schemes** are sovereign-backed investment instruments offered by India Post. Backed by government guarantee, these schemes provide guaranteed returns and capital protection.

This planner supports five major Post Office schemes: **POMIS, NSC, KVP, SCSS, and POTD**.

---

### Supported Schemes and Calculation Formulas
...
### Worked Numerical Example (POMIS - Verified against Code)
...
* **Q1: Are small savings scheme interest rates fixed for the entire tenure?**
  * A1: Yes, once you deposit funds in schemes like NSC, KVP, SCSS, or POTD, your interest rate stays locked for the entire tenure.
