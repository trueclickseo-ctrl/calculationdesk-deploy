...
#### 1. Arithmetic Mean ($\bar{x}$) & Sum of Squares (SSD)
- **Arithmetic Mean**:
  x_bar = (sum x_k) / N
...
1. **Count & Arithmetic Mean**:
   - Count ($N$) = **4**
   - Sum = $2 + 4 + 8 + 16 = \mathbf{30}$
   - Mean ($\bar{x}$) = $30 / 4 = \mathbf{7.5}$
2. **Sum of Squared Deviations (SSD)**:
   - $(2 - 7.5)^2 = (-5.5)^2 = 30.25$
   - $(4 - 7.5)^2 = (-3.5)^2 = 12.25$
   - $(8 - 7.5)^2 = (0.5)^2 = 0.25$
   - $(16 - 7.5)^2 = (8.5)^2 = 72.25$
   - **SSD** = $30.25 + 12.25 + 0.25 + 72.25 = \mathbf{115.00}$
3. **Variances**:
   - Population Variance ($\sigma^2$) = $115 / 4 = \mathbf{28.7500}$
   - Sample Variance ($s^2$) = $115 / 3 = \mathbf{38.3333}$
4. **Standard Deviations**:
   - Population SD ($\sigma$) = $\sqrt{28.75} \approx \mathbf{5.3619}$
   - Sample SD ($s$) = $\sqrt{38.3333} \approx \mathbf{6.1914}$
5. **Geometric & Harmonic Means**:
   - Geometric Mean = $(2 \times 4 \times 8 \times 16)^{1/4} = 1024^{0.25} \approx \mathbf{5.6569}$
   - Harmonic Mean = $4 / (1/2 + 1/4 + 1/8 + 1/16) = 4 / (15/16) \approx \mathbf{4.2667}$
