...
* **Gross Profit ($)**: The raw dollar amount earned after subtracting direct product cost from revenue (Revenue - Cost).
...
Target Selling Price = (C / 1 - frac(M){100)}

If targeting a **Markup Percentage** (K%):
Target Selling Price = C × 1 + (K / 100)
...
1. **Calculate Gross Profit**:
 Gross Profit = \100 - $70 = $30.002. **Calculate Profit Margin**:Profit Margin =  (30 / 100)  × 100 = 30.00%3. **Calculate Markup Rate**:Markup Rate =  (30 / 70)  × 100 = 42.857% (≈ 42.86%)#### Mode 2: Reverse Finding Selling Price for a 30% Target Margin
1. **Calculate Target Selling Price**:Target Price = ($70 / 1 - 0.30) = ($70 / 0.70) = $100.00 
...
* **Incorrect Method**: Adding a 30% markup ($70 × 1.30 = $91). Selling at \91 yields a profit of \21. The actual margin is 21 / 91 = 23.08%$—far short of the 30% target!
* **Correct Method**: Using the margin formula ($70 / 0.70 = $100). Selling at \100 yields a profit of \30, which is a true 30.00% profit margin.

---

### Real-World Business Applications

* **Retail & E-Commerce**: When selling physical products online, setting a target gross margin of 50--60% ensures you have sufficient margin to cover credit card processing fees ($2.9%), platform fees, advertising acquisition costs, and customer returns.
* **Services & Freelancing**: Hourly rates should factor in non-billable administrative time and software overhead by marking up direct labor costs by 50--100%.
