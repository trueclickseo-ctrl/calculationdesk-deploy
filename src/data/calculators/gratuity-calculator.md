...
$$\text{Rounded Years} = \text{Completed Years} + (\text{Extra Months} > 6 ? 1 : 0)$$

$$\text{Accrued Gratuity} = \frac{15 \times (\text{Basic Salary + DA}) \times \text{Rounded Years}}{26}$$
...
$$\text{Accrued Gratuity} = \frac{15 \times (\text{Basic Salary + DA}) \times \text{Completed Years}}{30}$$

#### 3. Tax Exemption & Taxable Gratuity

$$\text{Tax-Free Gratuity} = \min(\text{Accrued Gratuity}, 2000000)$$

$$\text{Taxable Gratuity} = \max(0, \text{Accrued Gratuity} - 2000000)$$
...
1. **Service Rounding**:
   ...
   - Rounded Service Tenure = $10 + 1 = \mathbf{11\text{ years}}$.
2. **Accrued Gratuity Calculation**:
   $$\text{Gratuity} = \frac{15 \times 80,000 \times 11}{26} = \frac{13,200,000}{26} \approx \mathbf{₹5,07,692.31}$$
3. **Tax Treatment**:
   - Statutory Ceiling = **₹20,00,000**.
   - Tax-Free Amount = $\min(507,692, 2000000) = \mathbf{₹5,07,692}$.
   - Taxable Amount = $\max(0, 507,692 - 2000000) = \mathbf{₹0}$.
