...
* **Lean Body Mass (LBM)**: Total body weight minus fat mass (LBM = Total Weight - Fat Mass).
...
LBM_{Boer} = 0.407(80) + 0.267(180) - 19.2
LBM_{Boer} = 32.56 + 48.06 - 19.2 = 61.42  kg
- **Lean Fraction**: (61.42 / 80) × 100 = 76.8%
- **Estimated Fat Mass**: 80 - 61.42 = 18.58  kg ($23.2%$ fat mass)

#### 2. James Formula Calculation:
Ratio = (80 / 180) = 0.4444 implies Ratio^2 = 0.1975
LBM_{James} = 1.10(80) - 128 × 0.1975 = 88.0 - 25.28 = 62.72  kg
- **Lean Fraction**: (62.72 / 80) × 100 = 78.4%
- **Estimated Fat Mass**: 80 - 62.72 = 17.28  kg ($21.6%$ fat mass)
...
* **Setting Protein Targets**: Nutrition guidelines often recommend consuming 1.6  to  2.2  grams of protein per kg of Lean Body Mass to maximize muscle retention.
