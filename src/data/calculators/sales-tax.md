...
Tax Component = P × (R / 100)
Total Amount = P + Tax Component = P × 1 + (R / 100)

#### Mode 2: Tax-Inclusive Method (Extracting Tax from Total Price)
Given Total Price T and Tax Rate R%:
Pre-Tax Amount = (T / 1 + frac(R){100)}
Tax Component = T - Pre-Tax Amount
...
1. **Calculate Tax Component**:
 Tax = \100 × 0.08 = $8.002. **Calculate Total Amount**:Total = $100 + $8.00 = $108.00 
#### Example 2: Tax-Inclusive Calculation (Total Price = 100, Tax Rate = 8%)
1. **Calculate Pre-Tax Amount**:
 Pre-Tax = (\100 / 1 + 0.08) = ($100 / 1.08) = 92.59259... (≈ $92.59)2. **Calculate Extracted Tax Component**:Tax = $100 - $92.59259 = 7.4074... (≈ $7.41)$
...
A common bookkeeping mistake when extracting tax from a 108 tax-inclusive receipt is taking 8% directly of 108 ($108 × 0.08 = $8.64). 
