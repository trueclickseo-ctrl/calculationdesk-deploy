...
faqs:
 ...
 a: "A standard full-time schedule of 40 hours per week across 52 weeks equals 2,080 work hours per year ($52 × 40 = 2,080). Dividing an annual salary by 2,080 yields the equivalent un-adjusted hourly wage."
...
* **24 Semi-Monthly Pay Periods / Year**: Paying twice per month ($12 × 2 = 24).
* **2,080 Standard Annual Work Hours**: Full-time work ($40  hrs/week × 52  weeks).
* **260 Standard Annual Work Days**: Full-time work ($5  days/week × 52  weeks).
...
- **From Hourly (H)**: A = H × Hours/Week × 52
- **From Daily (D)**: A = D × Days/Week × 52
- **From Weekly (W)**: A = W × 52
- **From Bi-Weekly (BW)**: A = BW × 26
- **From Semi-Monthly (SM)**: A = SM × 24
- **From Monthly (M)**: A = M × 12
- **From Annually**: A = Input Amount

#### Step 2: Divide Across Frequencies
Monthly = (A / 12) Semi-Monthly = (A / 24) Bi-Weekly = (A / 26)
Weekly = (A / 52) Daily = (A / 52 × Days/Week) Hourly = (A / 52 × Hours/Week)
...
1. **Annual Salary**: \50,000.00
2. **Monthly Salary**: \50,000 / 12 = $4,166.67
3. **Semi-Monthly Salary (24 paychecks)**: \50,000 / 24 = $2,083.33
4. **Bi-Weekly Salary (26 paychecks)**: \50,000 / 26 = $1,923.08
5. **Weekly Salary**: \50,000 / 52 = $961.54
6. **Daily Wage** ($52 × 5 = 260  days): \50,000 / 260 = $192.31
7. **Hourly Rate** ($52 × 40 = 2,080  hours): \50,000 / 2,080 = $24.04 / hr
...
* **Bi-Weekly (26 Paychecks)**: You are paid every two weeks on a specific day of the week (e.g. every second Friday). Because 26 × 2 = 52 weeks, there are **two months each year that contain 3 paychecks** instead of 2.
...
Because a bi-weekly schedule has 26 paychecks instead of 24, each bi-weekly paycheck is slightly smaller (\1,923.08 vs \2,083.33 on a \50k salary), but you receive two "extra" paychecks over the course of a year.
...
* **Q2: How many work hours are in a standard full-time year?**
  * A2: A standard full-time schedule of 40 hours per week across 52 weeks equals 2,080 work hours per year ($52 × 40 = 2,080). Dividing an annual salary by 2,080 yields the equivalent un-adjusted hourly wage.
