...
faqs:
  - q: "How is RD interest calculated by banks?"
    a: "Commercial banks compound RD interest quarterly. Each monthly deposit earns interest for the exact number of remaining months it stays in the account ($M = \sum_{k=1}^{n} P \times (1 + \frac{r}{400})^{k/3}$)."
...
- **$k$ (Remaining Months)**: Number of months each installment stays in the account ($k = n - \text{month} + 1$).
...
2. **Sum All 60 Monthly Installments**:
   - Month 1 Deposit ($k=60$): $\$5,000 \times (1.017)^{60/3} = \$5,000 \times (1.017)^{20} = \$7,002.39$
   - Month 2 Deposit ($k=59$): $\$5,000 \times (1.017)^{59/3} = \$6,962.97$
   - $\dots$
   - Month 60 Deposit ($k=1$): $\$5,000 \times (1.017)^{1/3} = \$5,028.18$
3. **Total Calculation Summary (Verified against Code)**:
   - **Total Principal Invested**: $\$5,000 \times 60 = \mathbf{\$300,000}$
