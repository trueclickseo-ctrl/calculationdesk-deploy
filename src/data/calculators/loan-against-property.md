...
aiSummary:
  ...
  quickAnswer: "Pledging a $500,000 property at a 60% LTV ratio limit unlocks a $300,000 loan principal. At an 8.5% interest rate over 15 years, the monthly EMI is $2,954.21 ($231,758 total interest payable)."
  formulaSummary: "Approved Principal P = Property Value × (LTV / 100) | EMI = P × r × (1 + r)^N / ((1 + r)^N - 1) | Total Interest = (EMI × N) - P"
  ...
  limitations: "Calculates loan eligibility based on user-entered property market value and LTV percentage limits."
  keyTakeaways:
...
examples:
  - title: "15-Year Loan Against Property ($500,000 Property Value, 60% LTV Limit, 8.5% p.a. Interest)"
    ...
    calculation: "Approved Loan Principal P = 500,000 × 60% = $300,000. Monthly rate r = 8.5 / 12 / 100 = 0.00708333; Months N = 180. EMI = 300,000 × 0.00708333 × [(1.00708333)^180 / ((1.00708333)^180 - 1)] = $2,954.21/month. Total Payment = $531,758. Total Interest = $231,758."
...
5. **Summary**:
   ...
   - **LTV Ratio**: **60%**
   - **Approved Loan Principal**: **$300,000**
   - **Monthly EMI**: **$2,954.21**
   - **Total Interest Paid**: **$231,758**
