...
faqs:
  ...
  - q: "How is the monthly pension calculated?"
    a: "Monthly pension is calculated by multiplying your total annuity corpus by the assumed annual annuity interest rate and dividing by 12 ($\text{Monthly Pension} = \frac{\text{Annuity Corpus} \times \text{Annuity Rate}}{12 \times 100}$)."
  - q: "Does the calculator account for existing NPS balances?"
    a: "Yes. You can enter a 'Current NPS Balance' ($C$). The calculator compounds your existing balance alongside your ongoing monthly contributions ($C \times (1 + r)^n$)."
references:
...
2. **Current Age & Retirement Age ($n$)**: Establishes total investment months ($n = (\text{Retirement Age} - \text{Current Age}) \times 12$).
3. **Expected Return Rate (%)**: The annual investment growth rate ($r = \text{Annual Return} \div 12 \div 100$).
...
1. **Investment Horizon**: $35\text{ years} = 420\text{ months}$.
2. **Monthly Growth Rate ($r$)**: $10\% \div 12 \div 100 = 0.008333\text{ per month}$.
...
4. **Principal Invested vs. Growth**:
   - Total Invested Principal: $₹10,000 \times 420 = \mathbf{₹42,00,000}$
   - Interest / Growth Earned: $₹3,82,82,768 - ₹42,00,000 = \mathbf{₹3,40,82,768}$
