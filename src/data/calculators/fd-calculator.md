...
faqs:
 ...
 a: "The calculator uses the compound interest equation: A = P × 1 + (r / n × 100)^n × t, where n represents the compounding frequency per year."
...
2. **Apply the FD Formula**:
 A = 100,000 × 1 + (6.5 / 4 × 100)^4 × 5
 A = 100,000 × (1 + 0.01625)^20
 A = 100,000 × (1.01625)^20 ≈ \138,041.99 3. **Summary (Verified against Code)**:
 - **Invested Principal**: **$100,000**
 - **Estimated Interest Earned**: \138,042 - $100,000 = $38,042
...
* **Q1: Can I calculate FD tenure in months instead of years?**
  * A1: Yes, our calculator allows you to toggle tenure inputs between years and months. When entering months, the calculator automatically converts tenure to fractional years (t = months ÷ 12).
