...
* **Total Earnings (On-Target Earnings / OTE)**: The complete gross pay earned during the period ($\text{Total Earnings} = B + C$).
...
$$\text{Commission} = \text{Total Sales Amount } (S) \times \left( \frac{\text{Commission Rate \%}}{100} \right)$$
$$\text{Total Earnings} = \text{Base Salary } (B) + \text{Commission}$$
...
$$\text{Commission} = \sum_{i=1}^{n} \left( \text{Eligible Sales in Tier } i \times \frac{\text{Tier Rate } i \%}{100} \right)$$
...
1. **Calculate Commission Payout**:
   $$\text{Commission} = \$25,000 \times \left(\frac{5}{100}\right) = \$25,000 \times 0.05 = \mathbf{\$1,250.00}$$
2. **Calculate Total Earnings**:
   $$\text{Total Earnings} = \$2,000 \text{ (Base)} + \$1,250 \text{ (Comm)} = \mathbf{\$3,250.00}$$

#### Example 2: Tiered Commission Mode (Default 3-Tier Bracket Structure)
Using the calculator's default tier configuration:
- **Tier 1**: Up to $\$10,000 \implies \mathbf{3\%}$
- **Tier 2**: Up to $\$50,000 \implies \mathbf{6\%}$
- **Tier 3**: Unlimited (above $\$50,000$) $\implies \mathbf{10\%}$

1. **Tier 1 Calculation ($0 to $10,000)**:
   - Sales in Tier 1 $= \$10,000$
   - Tier 1 Commission $= \$10,000 \times 0.03 = \mathbf{\$300.00}$
...
2. **Tier 2 Calculation ($10,000 to $50,000)**:
   ...
   - Tier 2 Commission $= \$15,000 \times 0.06 = \mathbf{\$900.00}$
   - Remaining Sales $= \$0$
3. **Sum Total Tiered Commission**:
   $$\text{Commission} = \$300.00 + \$900.00 = \mathbf{\$1,200.00}$$
4. **Calculate Total Earnings**:
   $$\text{Total Earnings} = \$2,000 \text{ (Base)} + \$1,200 \text{ (Comm)} = \mathbf{\$3,200.00}$$
...
* **Confusing Gross Revenue with Gross Margin**: Some plans pay commission on total sales revenue ($\$25,000$), while others pay commission on gross profit margin dollars ($\text{Sales} - \text{Product Cost}$). Ensure you enter the correct baseline amount.
