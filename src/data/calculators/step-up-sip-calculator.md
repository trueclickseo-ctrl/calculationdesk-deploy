...
faqs:
 ...
 a: "The step-up percentage is applied at the beginning of each new investment year (m=13, 25, 37, dots). Your monthly contribution remains fixed for 12 months, then increases by your step-up rate (P_y = P_{y-1} × (1 + Step-Up/100)) for the next 12 months."
...
2. **Monthly Compounding Loop**: Each month, monthly return rate (r = Annual Return ÷ 12 ÷ 100) is applied to the accumulated balance plus the current monthly contribution.
...
Balance_m = (Balance_{m-1} + P_y) × 1 + frac(Annual Rate){12 × 100}
...
1. **Monthly Contribution Schedule**:
 ...
 - Year 2 (Months 13–24): \5,000 × 1.10 = $5,500.00 / month
 - Year 3 (Months 25–36): \5,500 × 1.10 = $6,050.00 / month
 - dots
 - Year 10 (Months 109–120): \11,789.74 / month
2. **Run 120-Month Simulation Loop**:
 - Monthly Interest Rate: 12% ÷ 12 = 1% = 0.01 per month.
...
3. **Summary (Verified against Code)**:
 ...
 - **Estimated Returns Earned**: \1,675,548 - $956,470 = $719,078
