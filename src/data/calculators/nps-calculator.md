...
faqs:
 ...
 a: "Monthly pension is computed by multiplying the annuity corpus by the expected annual annuity return rate and dividing by 12 (Monthly Pension = frac(Annuity Corpus × Annuity Rate){12 × 100})."
references:
...
- **r**: Monthly expected return rate (Expected Return % ÷ 12 ÷ 100).
- **n**: Total investment months ((Retirement Age - Current Age) × 12).
...
2. **Principal Invested vs. Growth**:
 - Total Principal Invested: ₹10,000 × 420 = ₹42,00,000$
 - Interest / Capital Growth: ₹3,82,82,768 - ₹42,00,000 = ₹3,40,82,768$
